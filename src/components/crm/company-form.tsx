...
import type { ActionState, Company, Option } from "@/lib/crm/types";

/**
 * Company create/edit form. With no `company` prop it renders a toggleable
 * "New company" button revealing the create form (createCompany redirects to
 * the new company). With a `company` prop it renders an inline "Edit" toggle
 * bound to updateCompany, which revalidates and closes on success. Matches the
...
export function CompanyForm({
  ...
  return (
    <div className={wrapperClass}>
      <p className="eyebrow mb-4">{editing ? "Edit company" : "New company"}</p>
